...
// imported PACKAGES
import com.crownhounds.packagekeyword.TestPackageKeyword;
...
class StaticStatement extends Notes {
    ...
    /*
        ? STATIC FIELD: a unique class-level shared variable belong to class blueprint and NOT with any specific instances
