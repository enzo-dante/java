...
public class DataStructures_BigO {
...
//        timeComplexity("counting sort algorithm");
        timeComplexity("radix sort algorithm");
    ...
    public static void timeComplexity(String dataStructure) {
        ...
        switch (dataStructure.toUpperCase()) {
            ...
            case "BUBBLE SORT ALGORITHM":
                DataStructures_Algorithms.bubbleSort();
                break;
            case "SELECTION SORT ALGORITHM":
                DataStructures_Algorithms.selectionSort();
                break;
            case "INSERTION SORT ALGORITHM":
                DataStructures_Algorithms.insertionSort();
                break;
            case "SHELL SORT ALGORITHM":
                DataStructures_Algorithms.shellSort();
                break;
            case "QUICK SORT ALGORITHM":
                DataStructures_Algorithms.quickSort();
                break;
            case "COUNTING SORT ALGORITHM":
                DataStructures_Algorithms.countingSort();
                break;
            case "RADIX SORT ALGORITHM":
                DataStructures_Algorithms.radixSort();
                break;
        }
    }
